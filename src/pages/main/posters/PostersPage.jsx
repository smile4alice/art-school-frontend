...
const PostersPage = () => {
  ...
  return (
    <>
      <SEO
        title="Київська дитяча школа мистецтв - афіша."
        description="Школа мистецтв Київ. Київська дитяча школа мистецтв Київ. Афіша Київської дитячої школи мистецтв №2 ім. М.І.Вериківського. Афіша КДШМ №2 ім. М.І.Вериківського."
      />
      <Container>
