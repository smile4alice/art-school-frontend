  ...
  return (
    <>
      <SEO
        ...
        description="Київська дитяча школа мистецтв №2 ім. М.І.Вериківського. Дитяча школа мистецтв Київ. Музей Михайла Вериківського розташовується в КДШМ №2 ім. М.І.Вериківського."
      />
      {!isDesktop ? (
            ...
            {museumData.map(item => (
              <SwiperSlide className={styles.slideContent} key={item.id}>
                <div className={styles.slidePhoto}>
                  ...
                  <img
                    src={item.media}
                    alt="Фото музею Михайла Вериківського"
                  />
                </div>
              </SwiperSlide>
            ))}
