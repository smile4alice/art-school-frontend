...
const Museum = ({ museumData }) => {
  ...
  return (
    <>
      <SEO
        title="Музей Михайла Вериківського Київської дитячої школи мистецтв №2 ім. М.І.Вериківського"
        description="Михайло Вериківський – композитор європейського рівня. Діяльність Михайло Івановича Вериківського, була спрямована на розвиток різних сфер музичного мистецтва."
      />
      {!isDesktop ? (
