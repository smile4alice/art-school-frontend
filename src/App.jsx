  ...
  return (
    <HelmetProvider context={helmetContext}>
      <SEO
        ...
        description="КДШМ №2 ім. М.І.Вериківського. Дитяча школа мистецтв Київ. Київська школа мистецтв. Музична школа Київ. Хореографічна школа Київ. Образотворча школа Київ."
      />
      <Router>
        <RemoveTrailingSlash />
        <Routes>
