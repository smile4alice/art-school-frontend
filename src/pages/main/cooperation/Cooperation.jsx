      ...
      <Container>
        <div className={styles.Cooperation}>
          <div className={styles.wrapper}>
            <p>
             Уявіть, що Ваш захід проводиться в одній із найкрасивіших концертних зал, розрахованих на 288 місць, у самому серці столиці! Як по завершенню концерту чи після перегляду вистави щаслива публіка йде прогулятися історичним центром міста - Пейзажною алеєю, Андріївським узвозом, Київським дитинцем. <br></br>Уявили? З нами це можливо! КДШМ #2 ім. М. І. Вериківського гостинно запрошує скористатися концертною та виставковою залами закладу, де у Вас буде технічна можливість втілити будь-яку сучасну ідею! До ваших послуг також шкільна студія звукозапису!
            </p>
