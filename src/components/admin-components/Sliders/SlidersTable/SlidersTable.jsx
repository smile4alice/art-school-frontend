  ...
  return (
    <div className={styles.contentWrap}>
      ...
      <div className={styles.tableRow}>
        <div className={styles.cellSliderRow}>1</div>
        <div className={styles.cellHeadingRow}>Tabile modern school</div>
        <div className={styles.cellTextRow}>
          Tabile modern school проводить набір дітей за напрямком сучасний
          танець (модерн танець, контемпорарі), до 1-го класу 6-7 років та 8-9
          років до 2-го кла
        </div>
