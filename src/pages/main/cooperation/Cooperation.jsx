...
const Cooperation = () => {
  ...
  return (
    <>
      <SEO
        title="Співпраця з Київською дитячою школою мистецтв №2 ім. М.І.Вериківського! Концертна зала, Студія звукозапису та Виставкова зала"
        description="КДШМ #2 ім. М. І. Вериківського гостинно запрошує скористатися однією із найкрасивіших концертних зал у самому серці столиці. 
        До ваших послуг також виставковою залами закладу та шкільна студія звукозапису!"
      />
      <Container>
